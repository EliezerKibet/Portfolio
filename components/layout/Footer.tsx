                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <nav className="flex flex-col space-y-2">
                            <Link
                                href="/"
                                className="text-gray-600 dark:text-gray-300 hover:text-primary-600 transition duration-200"
                            >
                                Home
                            </Link>
                            <Link
                    ...
                    <div>
                        ...
                        <Link
                            href="/contact"
                            className="inline-block px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 transition duration-200 mt-2"
                        >
                            Get in Touch
                        </Link>
                    </div>
